...
#[rstest]
#[case("DEDUPE_MAX_DEPTH", "5", Some(5))]
#[case("DEDUPE_MIN_FILE_SIZE", "1024", 1024)]
#[case("DEDUPE_MODE", "remove", OperationMode::Remove)]
fn test_config_from_env(
    #[case] env_var: &str,
    #[case] env_value: &str,
    #[case] expected_value: impl std::fmt::Debug + PartialEq,
) {
